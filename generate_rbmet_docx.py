...
def create_rbmet_docx():
    ...
    add_p("The corresponding surface pressure evolution during the lee cyclogenesis and post-Andean transition is documented in the synoptic and meso-alpha analysis of Mean Sea Level Pressure (SLP) from ERA5 (Figure 4). To resolve the intense pressure drop on the lee side of the Andes, Figure 4a displays a high-resolution regional zoom centered on Mendoza and the Cuyo region at 19 UTC on December 20, 1995, plotted with a refined contour interval of 2 hPa. The regional thermal-orographic Northwestern Argentine Low (BNOA; Seluchi and Saulo, 2012) intensified markedly east of the Andes, reaching a regional minimum of 987.2 hPa at 22 UTC on December 20 (989.6 hPa at 21/12 00 UTC; 29.5°S, 66.5°W). While the local station point of Mendoza (32.89°S, 68.84°W) experienced a local minimum of 995.1 hPa at 19 UTC on December 20 (surface pressure sp = 914.5 hPa; red star in Figure 4a), the true center of deepest cyclogenetic deepening was located across the broader Cuyo/BNOA depression (San Juan, La Rioja, Catamarca, and northern Mendoza).")
    add_p("Figure 4b presents the hourly SLP evolution during the lee cyclogenesis from December 18 to 22, 1995 (120 hourly steps), comparing the regional lee low central pressure (crimson line) with the local station point of Mendoza (blue dashed line). Across the regional depression, the central pressure dropped precipitously by 20.9 hPa in 30 hours (falling from 1010.9 hPa on 19/12 14 UTC to 990.0 hPa on 20/12 20 UTC at 30.5°S, 68.5°W, and reaching an absolute minimum of 987.2 hPa at 20/12 22 UTC). Over 24 hours, the maximum regional pressure drop reached 17.6 hPa (from 1018.3 hPa on 19/12 22 UTC to 1000.7 hPa on 20/12 22 UTC at 26.5°S, 67.5°W). When evaluated using Sanders and Gyakum's (1980) latitude-adjusted explosive cyclogenesis criterion (where the 1 Bergeron threshold is 12.4 to 14.1 hPa/24 h between 26.5°S and 30.5°S), this 17.6 hPa/24 h deepening rate corresponds to E = 1.26 to 1.42 Bergeron. This confirms that the regional Andean lee cyclogenesis fully satisfied the criterion for an explosive cyclogenesis ('meteorological bomb'), perfectly aligning with the 19 hPa in 30 hours drop documented in the doctoral thesis (Haas, 2002). At Mendoza station itself, the local pressure fell 12.8 hPa in 24 hours (15.9 hPa in 30 hours) before rebounding abruptly by +15.7 hPa in 10 hours following the cold front.")
    ...
    add_figure("Figure_4_SLP_ERA5.png", "Figure 4. Mean Sea Level Pressure (SLP) analysis from ERA5: (a) Regional zoom on Mendoza and Cuyo at 20/12/1995 19 UTC, contoured every 2 hPa (986 to 1024 hPa), with the red star indicating Mendoza (995.1 hPa); (b) Hourly time series of SLP (hPa) from 18 to 22 December 1995 showing the regional lee low central pressure (crimson curve; 30-h drop of 20.9 hPa, 24-h drop of 17.6 hPa, reaching 987.2 hPa and satisfying the Sanders and Gyakum (1980) explosive cyclogenesis / bomb criterion at E = 1.42 Bergeron) compared with the local Mendoza station point (blue dashed curve; minimum 995.1 hPa); (c) Synoptic SLP on 22/12/1995 00 UTC (surface cyclone over Uruguay at 1003.3 hPa, 4 hPa contour interval); and (d) Synoptic SLP on 25/12/1995 00 UTC (decaying coastal trough, Uruguay low filled to 1008.0 hPa). In panels (a), (c), and (d), Andean topography above 2000 m is masked in gray.")
    ...
    add_p("2. Andean transit and explosive lee cyclogenesis: Mountain transit induced severe vertical compression followed by lee stretching, causing the vortex axis to tilt eastward before recovering an upright equivalent barotropic column east of the Andes. This triggered explosive regional lee cyclogenesis, with the thermal-orographic Northwestern Argentine Low (BNOA / Cuyo) deepening by 20.9 hPa in 30 hours (17.6 hPa in 24 hours) to an hourly minimum of 987.2 hPa (989.6 hPa at 21/12 00 UTC). With a latitude-adjusted deepening rate of E = 1.26 to 1.42 Bergeron, the reanalysis fully corroborates the classification of the Andean lee cyclogenesis as an explosive cyclone ('bomb'), in agreement with Haas (2002). At the local Mendoza station point (32.89°S, 68.84°W), SLP dropped to a sharp minimum of 995.1 hPa on 20/12 19 UTC before surging by +15.7 hPa in 10 hours following the frontal passage.")
