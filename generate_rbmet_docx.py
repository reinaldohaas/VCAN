...
def create_rbmet_docx():
    ...
    add_p("Between December 18 and 20, the upper-level IPV anomaly experienced rapid intensification over the Pacific. Diagnostic analysis reveals that this deepening was driven by coupling with a pre-existing cyclonic IPV anomaly near the surface (850 hPa), dammed along the Chilean coastline near 80°W, 35°S (Figure 2).")
    add_p("The upper-level IPV anomaly at 400 hPa was positioned approximately a quarter-wavelength (λ/4) upshear (west) of the low-level cyclonic center. This classical vertical phase locking produced mutual baroclinic amplification (Hirschberg and Fritsch, 1991; Hoskins et al., 1985), priming the system before it reached the mountains.")
    add_figure("Proof_1_Pacific_Pre_Andes_VPI.png", "Figure 2. Baroclinic coupling over the southeastern Pacific on 19/12/1995 at 00 UTC. Shading: 850 hPa cyclonic IPV (UVP). Dashed contours: 400 hPa IPV (>= 1.5 UVP, stratospheric intrusion). Blue contours: 400 hPa geopotential height (m). Brown line: Andes Cordillera axis. Source: ERA5 Reanalysis.")
    ...
    add_p("This anomalous track is explained by upper-level barotropic instability. Figure 8 demonstrates that between 300 and 100 hPa, extreme meridional shear in the zonal wind caused the absolute vorticity gradient Q_y = β - d²ū/dy² to reverse sign exactly across the latitude of deflection (~25–30°S). Satisfying Kuo's (1949) condition, the vortex extracted kinetic energy from the mean jet, maintaining high cyclonic IPV (> 1.6–2.0 UVP; Figure 7b) despite moving toward lower latitudes where planetary vorticity |f| decreases.")
    ...
    add_figure("Figure_10_Barotropic_ERA5.png", "Figure 7. Barotropic instability diagnostics averaged between 300 and 100 hPa for December 22–28, 1995: (a) Parameter Q_y (x 10⁻¹¹ m⁻¹ s⁻¹), with the zero contour highlighted in black indicating satisfaction of Kuo's criterion; (b) Mean zonal wind ū (m s⁻¹). Source: ERA5 Reanalysis.")
