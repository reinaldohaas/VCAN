...
def create_rbmet_docx():
    ...
    add_p("During the last two weeks of December 1995, a synoptic baroclinic disturbance crossed the Andes Cordillera and evolved into a long-lived Upper Tropospheric Cyclonic Vortex (UTCV) that propagated anomalously northeastward along the southern and southeastern coast of Brazil. The system induced widespread extreme precipitation episodes, flash floods, and substantial socio-economic damage. In this study, the dynamic and thermodynamic lifecycle of the UTCV is investigated within the framework of Ertel Isentropic Potential Vorticity (IPV thinking) using the high-resolution ECMWF Reanalysis v5 (ERA5, 0.25° × 0.25°) and NOAA GridSat-B1 calibrated geostationary infrared observations. Our diagnostic results demonstrate that: (1) baroclinic coupling between an upper-level tropopause fold (q ≥ 1.5 UVP at 400 hPa) and a shallow boundary-layer cyclonic IPV anomaly dammed west of the Chilean coast pre-conditioned the initial intensification; (2) during Andean transit, the vortex axis tilted eastward before realigning vertically on the lee side into an equivalent barotropic column, inducing regional lee cyclogenesis associated with the Northwestern Argentine Low (BNOA; minimum sea level pressure of 989.6 hPa at 29.5°S, 66.5°W on 20/12 18 UTC); (3) upon reaching Southeastern South America (SESA), coastal re-intensification on 22/12 (peak 400 hPa IPV of 2.79 UVP) was maintained by low-level moisture convergence and an equivalent potential temperature (θe) tongue (341–343 K at 925 hPa); and (4) the anomalous northeastward displacement from 35.5°S to 24.3°S between 21 and 28 December was dynamically sustained by upper-tropospheric barotropic instability across 300–100 hPa, where the meridional gradient of absolute vorticity Q_y = β - d²ū/dy² reversed sign (crossing zero at ~28.8°S), satisfying Kuo's necessary instability condition.")
    ...
    add_p("Calibrated infrared (11 µm) window brightness temperatures from the GOES-8 geostationary satellite were obtained from the NOAA National Centers for Environmental Information (NCEI) GridSat-B1 climate data record (Knapp et al., 2011).")
    add_p("In hydrostatic pressure coordinates, Ertel's Potential Vorticity is formulated as:")
    ...
    add_p("Prior to impinging upon the Andes Cordillera, the vortex experienced notable baroclinic amplification between December 17 and 19 over the eastern Pacific. Figure 2 presents a vertical cross-section along 35°S at 18 UTC on December 18, 1995, depicting Ertel cyclonic IPV (q, shaded) and isentropes (black contours).")
    ...
    add_figure("Figure_2_Pacific_Pre_Andes_VPI.png", "Figure 2. Vertical cross-section along 35°S of Ertel Isentropic Potential Vorticity (q in UVP, shaded) and potential temperature (isentropes in black contours, interval 5 K) on 18/12/1995 at 18 UTC from ERA5 reanalysis. Shading highlights the upper-level tropopause fold (q ≥ 1.5 UVP) near 88°W and the shallow coastal IPV anomaly below 850 hPa dammed west of the Andes (~78°W). Topography is masked in gray below surface pressure.")
    ...
    add_figure("Figure_3_Andes_CrossSection_Tilt.png", "Figure 3. Vertical cross-section along 27.5°S of Ertel Isentropic Potential Vorticity (q in UVP, shaded) and isentropes (black contours, interval 5 K) from ERA5 reanalysis for: (a) 20/12/1995 00 UTC (westward tilt during Andean approach); and (b) 22/12/1995 00 UTC (upright, equivalent barotropic alignment downstream of the Andes). The dashed red line marks the cyclonic vortex axis. Topography is masked in gray below surface pressure.")

    add_p("The corresponding surface pressure evolution is documented in the synoptic sequence of Mean Sea Level Pressure (SLP) from ERA5 (Figure 4). On December 21 at 00 UTC (Figure 4a), intense lee cyclogenesis is evident across northwestern and central Argentina. The regional minimum SLP of 989.6 hPa occurred at 29.5°S, 66.5°W in La Rioja/Catamarca at 18 UTC on December 20, corresponding to a pronounced thermal-orographic Northwestern Argentine Low (BNOA; Seluchi and Saulo, 2012). At Mendoza (32.89°S, 68.84°W), SLP reached a local trough minimum of 995.7 hPa at 18 UTC on December 20, rising to 1005.2 hPa by 00 UTC on December 21 as the cold front swept eastward. Although this pressure drop was vigorous, it did not satisfy the classical 'meteorological bomb' threshold for this latitude (Sanders and Gyakum, 1980), which requires a 24-hour geostrophically normalized deepening rate exceeding 1 Bergeron (~17.5 hPa/24 h at 30°S).")
    ...
    add_figure("Figure_4_SLP_ERA5.png", "Figure 4. Mean Sea Level Pressure (hPa, black contours, interval 4 hPa) from ERA5 reanalysis across key synoptic stages: (a) 21/12/1995 00 UTC (lee cyclogenesis over western/northwestern Argentina; local SLP at Mendoza is 1005.2 hPa); (b) 22/12/1995 00 UTC (surface cyclone over Uruguay at 1003.3 hPa); (c) 25/12/1995 00 UTC (decaying coastal trough, Uruguay low filled to 1008.0 hPa); and (d) 29/12/1995 00 UTC (dissipation phase). Topography above 2000 m is masked in gray.")

    add_heading("4.4 Coastal Re-intensification and Moisture Inflow over SESA", level=2)
    add_p("A central puzzle of the December 1995 UTCV was its prolonged vigor and devastating precipitation over Southeastern South America (SESA) despite the filling of the surface low. Figure 5 depicts the Ertel cyclonic IPV (q) and geopotential height at 400 hPa on December 22 at 00 UTC.")
    ...
    add_p("The trajectory and intensity of the vortex center were objectively tracked in ERA5 using the 400 hPa geopotential anomaly field (z₄₀₀' = z₄₀₀ - z̄₄₀₀(φ)) with a constrained local search radius (~5.5°). As depicted in Figure 8a, the vortex center moved smoothly from 35.50°S, 69.00°W on December 21 at 00 UTC to 24.25°S, 54.00°W on December 28 at 12 UTC, progressing northeastward across Argentina, Uruguay, Rio Grande do Sul, Santa Catarina, and Paraná.")
    ...
    add_figure("Figure_8_Northward_Trajectory_VPI.png", "Figure 8. Objective tracking and intensity evolution of the UTCV at 400 hPa from 21 to 28 December 1995: (a) Trajectory of the vortex center (tracked via geopotential anomaly z₄₀₀') colored by maximum cyclonic IPV (UVP); and (b) Time series of central geopotential anomaly (gpm, left axis, blue line) and core maximum cyclonic IPV (UVP, right axis, crimson line). Source: ERA5 Reanalysis.")
